...
let ordersTotal = orders.map( (object) => object.price * (1+object.tax));
...
let bobsTotal = purchases.filter( (object) => object.owner === 'Bob').reduce( (value, current) => { return value + current.price;
}, 0);
